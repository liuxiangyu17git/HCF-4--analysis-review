...
cat("描述: NHANES 2021-2023 (L周期) 论文1深入分析\n")
...
cat("\n四、输出文件清单\n")
cat(" results/paper1_deep_mediation.csv - C层中介\n")
cat(" results/paper1_deep_Dlayer.rds - D层深化\n")
cat(" results/paper1_deep_behavior.csv - 行为交互深入\n")
cat(" results/paper1_deep_composite_mediation.csv - 复合中介\n")
cat(" results/paper1_figure_deep_pa_effects.pdf - 体力活动图\n")
cat(" results/paper1_figure_deep_sleep_effects.pdf - 睡眠图\n")
sink()
cat(" ✅ 深入分析报告已保存\n\n")
# ============================================================================
# 10. 保存会话信息（期刊要求）
...
code_save_path <- file.path(scripts_dir, "11_paper1_deep_analysis_L.R")
cat("\n⚠️  请手动将当前脚本保存到以下位置：\n")
cat(sprintf("   %s\n\n", code_save_path))
